...
# This fork ships no upstream dataset. Assets are generated by our own pipeline into
# ../content/ (provenance-tracked). See ../UPSTREAM.md.
```

> Upstream's simulated apps were removed in this fork (see ../UPSTREAM.md). The RTL storefront apps arrive in Phase 3.
...
pnpm --filter @rtl/sim dev &                                              # http://localhost:3000
