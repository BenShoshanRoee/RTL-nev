...
| 2.1.2 | Commerce Domain Implementation | 2026-09-16 | `make verify` (27 commerce vitest cases: full flow, 10,000+ applied operations with invariants after each, coupon rules, KWD totals + ILS mix throws, conformance, sample/precondition agreement, hygiene grep); PR (see Decisions) | 16 entity schemas + cart singleton, 26 operations, 15 invariants, seed of ~50 products / ~100 variants / 7 coupons / 2 historical orders. No new dependencies. |
